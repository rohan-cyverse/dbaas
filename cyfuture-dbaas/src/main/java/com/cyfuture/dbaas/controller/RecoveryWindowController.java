...
@RestController
@RequestMapping("/api/v1/projects/{project}/databases/{databaseId}/recovery-window")
...
public class RecoveryWindowController {
    ...
    public RecoveryWindowResponse get(@PathVariable String project, @PathVariable String databaseId) {
        return pitrRecoveryService.response(pitrRecoveryService.window(project, databaseId));
    }
}
